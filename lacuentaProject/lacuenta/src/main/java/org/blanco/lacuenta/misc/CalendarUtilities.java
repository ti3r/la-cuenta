 ...
 * passed load target (SplitsDataLoader.TODAY_LOAD, SplitsDataLoader.WEEK_LOAD
 * or SplitsDataLoader.MONTH_LOAD). This calculate will return the start and end
 * of the current day, week or month in milliseconds format
 *
...
public class CalendarUtilities {
    ...
    public static class CalendarLimits {
        ...
        public String[] toStringArray() {
            return new String[] { String.valueOf(lowLimit),
                    String.valueOf(topLimit) };
        }
    }

    public static CalendarLimits getLoadLimits(String loadTarget) {
        Calendar cLow = Calendar.getInstance(); // Default Instances both for
        // today
        Calendar cTop = Calendar.getInstance();

        cLow.setTimeInMillis(System.currentTimeMillis()); // set the calendar a
        // this moment
        ...
        return new CalendarLimits(cLow.getTimeInMillis(),
                cTop.getTimeInMillis());
    }
    ...
    private static void setStartOfMonthToCalendar(Calendar c) {
        ...
        Log.d("La Cuenta: ", "Min of Current Month: "
    ...
    private static void setEndOfMonthToCalendar(Calendar c) {
        ...
        Log.d("La Cuenta: ", "Max of Current Month: "
                + DateFormat.getInstance().format(c.getTime()));
    }
    ...
    private static void setStartOfWeekToCalendar(Calendar c) {
        ...
        setStartOfDayToCalendar(c);
        Log.d("La Cuenta: ", "Min of Current Week: "
                + DateFormat.getInstance().format(c.getTime()));
    }
    ...
    private static void setEndOfWeekToCalendar(Calendar c) {
        ...
        setEndOfDayToCalendar(c);
        Log.d("La Cuenta: ", "Max of Current Week: "
                + DateFormat.getInstance().format(c.getTime()));
    }
