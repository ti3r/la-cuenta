 ...
 * database and let the user filter the data differently.
 *
 * The code of this class has been migrated from the SplitsActivity in order to
 * support fragments in the application.
 *
...
public class GraphFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mainLayout = (LinearLayout) inflater.inflate(
                R.layout.graph_fragment_initial_screen, null);
    ...
    /**
     * Method that will initialise the members of the class based on the passed
     * initial view that must have been created on the onCreateView method.
     *
     * @param view
     *            The initial View view where to retrieve the components from
     */
    private void initComponents(View view) {
        if (view == null) {
            throw new IllegalArgumentException("Initial View can't be null");
        }
        btnDay = (ImageButton) view
                .findViewById(R.id.graph_action_bar_btn_day_target);
        ...
        btnWeek = (ImageButton) view
                .findViewById(R.id.graph_action_bar_btn_week_target);
        ...
        btnMonth = (ImageButton) view
                .findViewById(R.id.graph_action_bar_btn_month_target);
    ...
    public void loadData() {
        if (dataLoader == null
                || !AsyncTask.Status.RUNNING.equals(dataLoader.getStatus())) {
