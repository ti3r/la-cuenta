...
/***
 * Class that implements the ResultReceiver Interface in order to express the
 * calculation result though voice.
 * 
...
public class SpeechResultReceiver implements ResultReceiver, OnInitListener {
	...
	public void onInit(int status) {
		if (ttp != null
				&& (ttp.isLanguageAvailable(locale) != TextToSpeech.LANG_NOT_SUPPORTED || ttp
						.isLanguageAvailable(locale) != TextToSpeech.LANG_MISSING_DATA))
			ttp.setLanguage(locale);
		else
			// Set English a default language
