...
public interface PageDisplayer {
	...
	/**
	 * This method should notify the user that the current page has changed.
	 * The implementation can vary from one class to another but the 
	 * notice must be visible for the user 
	 * @param pageIdx The int Index of the current page;
	 */
