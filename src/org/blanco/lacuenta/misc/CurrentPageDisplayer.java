...
/**
 * This class will display a Toast Message marking the current page index that
 * has been marked in the PageViewer
 * 
 * @author Alexandro Blanco <ti3r.bubblenet@gmail.com>
 * 
 */
public class CurrentPageDisplayer implements PageDisplayer{
	...
	/**
	 * This method does the actual displaying of the page in the format ..*..
	 * where the * is the current page displayed
	 * 
	 * @param pageIdx
	 *            The number of the page that is displayed
	 */
