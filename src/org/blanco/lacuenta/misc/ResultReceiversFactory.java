...
/**
 * The class in charge of creating the result receivers 
 * that will be attached to the CalculateClickListener
 * objects in order to present the results of a calculus
 * in the way the user desires it.
...
public class ResultReceiversFactory {
     ...
     * @param context The Context object where to retrieve the user preferences
     * @param textView The TextView object where to display the result if 
     * this option has been enabled by the user (the result is not displayed on a
     * result dialog).
    ...
    public static List<ResultReceiver> getResultReceivers(Context context, 
    	...
    	boolean textToSpeech = PreferenceManager.getDefaultSharedPreferences(context)
